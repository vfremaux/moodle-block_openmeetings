...
/**
* an ajax refresher for the user list when filtered
*
*/
function refreshuserlist(courseid, blockid, wwwroot, textobj){
	
	params = "id="+courseid+"&omid="+blockid+"&filter=" + textobj.value;
    var url = wwwroot + "/blocks/openmeetings/js/getusers.php?" + params;
